...
Инструкции по настройке уведомлений в Telegram будут добавлены позже.
```

Скопируйте этот код и вставьте его в файл `README.md` в вашем репозитории на GitHub. Этот файл поможет пользователям быстро начать работу с вашим проектом, настроить окружение и запустить тесты.
